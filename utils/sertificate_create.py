...
def certificate(fio, result):
    ...
    draw_text.text(((((name_start[0] + name_end[0]) / 2) - width_name / 2) + 155, 730 + 120), text=str(fio),
                   font=font_fio,
                   fill='#000000', align="center")
    # Пишем результат, тем же самым образом ищем центр
    draw_text.text(((((result_start[0] + result_end[0]) / 2) - width_result / 2) + 14, 1170), text=f'{str(result)}',
                   font=font_result,
                   fill='#000000')
