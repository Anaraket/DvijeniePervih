...
def certificate(fio, result):
    ...
    draw_text.text(((((name_start[0] + name_end[0]) / 2) - width_name / 2) + 165, 730 + 60), text=str(fio),
                   font=font_fio,
                   fill='#000000', align="center")
    # Пишем результат, тем же самым образом ищем центр
    draw_text.text(((((result_start[0] + result_end[0]) / 2) - width_result / 2) + 15, 1030), text=f'{str(result)}',
                   font=font_result,
                   fill='#000000')
