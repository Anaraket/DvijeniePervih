...
class Database():
    ...
    def populate_questions(self):
        ...
        for question in questions_base:
            try:
                self.cursor.execute(
                    "INSERT OR REPLACE INTO questions VALUES (:id, :number, :question, :answer1, :answer2, :answer3, :answer4, :correct_answer, :category)",
                    {'id': question['id'], 'number': question['number'], 'question': question['question'],
