...
class Database:
        ...
        questions_base = [
            ...
            },
            {
                ...
                "answers": ["Право на образование и обязанность учиться",
                            ...
                            "Право на собственность и обязанность уважать чужую собственность"],
            ...
            },
            {
                ...
                "answers": ["Не бегать по коридорам,\nНе драться",
                            ...
                            "Не курить в школе,\nНе приходить в школу в грязной одежде", "Все ответы верны"],
            ...
            },
            {
                ...
                "answers": ["Кража - это когда человек берет чужие вещи без разрешения",
                            ...
                            "Кража - это когда человек берет чужие вещи и использует их для себя"],
                "correct_answer": "Кража - это когда человек берет чужие вещи без разрешения",
                "category": 1
            },
            {
                'id': 7,
    ...
    # def update_columns(self, updates: dict, user_id: int):
    #     """
    #     Обновляет данные пользователя в указанных столбцах.
    #     :param updates: Словарь с именами столбцов в качестве ключей и новыми значениями в качестве значений.
    #     :param user_id: ID пользователя, данные которого нужно обновить.
    #     """
    #     # Формируем строку запроса динамически
    #     query = f"UPDATE users SET {', '.join([f'{column} = ?' for column in updates.keys()])} WHERE user_id = ?"
    #     # Добавляем user_id в список параметров
